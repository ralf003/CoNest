...
首页横幅使用 `../conest-banner*.svg`：英文和中文分别提供桌面、手机（600 px 及以下）、浅色与深色版本，均嵌入矢量标志路径。桌面主张字号 62–66，手机主张字号 62–76；删去细小装饰文案，正文使用原生文字保持可读性。PNG 上传文件由 Chromium 按原生像素尺寸导出，后续修改应从 SVG 重新导出。
