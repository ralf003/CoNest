...
export function executionEnvironment(source: NodeJS.ProcessEnv = process.env): NodeJS.ProcessEnv {
  const allowed = /^(PATH|HOME|USER|LOGNAME|SHELL|TMPDIR|TMP|TEMP|LANG|LC_[A-Z_]+|TZ|TERM|COLORTERM|NO_COLOR|SystemRoot|WINDIR|PATHEXT|COMSPEC|DSH_NODE_PTY_SPAWN_HELPER)$/;
