...
See the [compatibility matrix](../../docs/dsh-compatibility.md) for exact versions, injected services, mappings, results and limitations. [profile.mjs](profile.mjs) is test composition, **not a production plugin package**; its diagnostic capability must not be offered as a general Todo/Plan tool.
