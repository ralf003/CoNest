...
const output = path.join(root, 'reports/loader-feasibility');
const provenance = [];
...
try {
  result = await promisify(execFile)(process.execPath, ['--test', '--test-reporter=tap', '--test-timeout=20000',
    'experiments/loader/loader.test.mjs'], { cwd: root, env, timeout: 30_000, maxBuffer: 4_000_000 });
} catch (error) {
...
const testSources = {};
for (const file of ['experiments/loader/fixture.mjs', 'experiments/loader/loader.test.mjs', 'scripts/test-loader.mjs']) {
