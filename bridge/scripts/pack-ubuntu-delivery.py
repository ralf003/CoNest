...
const names = ['START-HERE-zh.md', 'SOURCE-NOTES-zh.md', 'docs/ubuntu-installation-demo-zh.md', 'docs/conest-design-zh.md'];
...
for (const name of names) {
  ...
  fs.writeFileSync(path.join(root,name.replace(/\.md$/,'.html')),`<!doctype html><html lang="zh-CN"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${title}</title><style>${css}</style><header><strong>CoNest</strong><p>Ubuntu 演示交付 · Connector 0.6.2</p><nav><a href="${rel}START-HERE-zh.html">开始使用</a><a href="${rel}docs/ubuntu-installation-demo-zh.html">安装与演示教程</a><a href="${rel}docs/conest-design-zh.html">当前设计</a><a href="${rel}SOURCE-NOTES-zh.html">源码说明</a></nav></header><main>${body}<footer>固定版本：OpenClaw 2026.9.2 · DSH 0.1.0-rc.5 · Node 24.15.0 · Ubuntu x86_64。文档可离线阅读。</footer></main></html>`);
}
'''
