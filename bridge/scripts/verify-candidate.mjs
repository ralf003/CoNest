...
const reportFiles = {
  ...
  defaultGateway: path.join(root, 'reports', `conest-${packageVersion}-default/e2e.json`),
  archiveGateway: path.join(root, 'reports', `conest-${packageVersion}-archive/e2e.json`),
};
const evidence = {};
