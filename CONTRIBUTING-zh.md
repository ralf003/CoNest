...
原开发机的 `.runtime`、`.tooling`、`source/workspace` 均不是必要前提。依赖来源、校验和 node-pty 补丁见 [DEPENDENCIES-zh.md](maintenance/DEPENDENCIES-zh.md)。不要将下载的 `.vendor`、`node_modules` 或状态文件提交到 Git。
