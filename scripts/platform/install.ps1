...
$Archive = Join-Path $DownloadDir 'node-v24.15.0-win-x64.zip'
Invoke-WebRequest -UseBasicParsing 'https://nodejs.org/dist/v24.15.0/node-v24.15.0-win-x64.zip' -OutFile $Archive
$Checks = (Invoke-WebRequest -UseBasicParsing 'https://nodejs.org/dist/v24.15.0/SHASUMS256.txt').Content
...
$Node = Join-Path $NodeDir 'node-v24.15.0-win-x64/node.exe'
